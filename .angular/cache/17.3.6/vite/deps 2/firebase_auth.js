...
import { __rest } from "./chunk-LHRTKJE6.js";
  ...
  initializeCurrentUserFromIdToken(idToken) {
    return __async(this, null, function* () {
      try {
        ...
        const user = yield UserImpl._fromGetAccountInfoResponse(
          this,
          response,
          idToken,
        );
...
var UserCredentialImpl = class _UserCredentialImpl {
  ...
  static _fromIdTokenResponse(
    ...
    return __async(this, null, function* () {
      const user = yield UserImpl._fromIdTokenResponse(
        auth,
        idTokenResponse,
        isAnonymous,
      );
...
function _link$1(user, credential, bypassAuthState = false) {
  return __async(this, null, function* () {
    const response = yield _logoutIfInvalidated(
      user,
      credential._linkToIdToken(user.auth, yield user.getIdToken()),
      bypassAuthState,
    );
...
function updateProfile(_0, _1) {
  return __async(
    this,
    arguments,
    function* (user, { displayName, photoURL: photoUrl }) {
...
var mintCookieFactory = (url) => (user) =>
