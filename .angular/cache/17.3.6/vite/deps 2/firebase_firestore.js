...
Sa.prototype.add = function (a, b2, c, d, e) {
  ...
  var h = Ta(a, b2, d, e);
  -1 < h
    ? ((b2 = a[h]), c || (b2.ia = false))
    : ((b2 = new Ja(b2, this.src, f, !!d, e)), (b2.ia = c), a.push(b2));
  return b2;
};
function Ua(a, b2) {
  var c = b2.type;
...
function Za(a, b2, c, d, e) {
  ...
  c = $a(c);
  return a && a[Ha]
    ? a.P(b2, c, p(d) ? !!d.capture : !!d, e)
    : ab(a, b2, c, true, d, e);
}
function fb(a, b2, c, d, e) {
  if (Array.isArray(b2))
    for (var f = 0; f < b2.length; f++) fb(a, b2[f], c, d, e);
  else
    ((d = p(d) ? !!d.capture : !!d), (c = $a(c)), a && a[Ha])
      ? ((a = a.i),
  ...
  if ("number" !== typeof a && a && !a.fa) {
    ...
    if (b2 && b2[Ha]) Ua(b2.i, a);
      ...
      b2.removeEventListener
        ...
        : b2.detachEvent
          ? b2.detachEvent(db(c), d)
          : b2.addListener && b2.removeListener && b2.removeListener(d);
      (c = bb(b2))
        ? (Ua(c, a), 0 == c.h && ((c.src = null), (b2[Va] = null)))
        : Ma(a);
    }
  }
}
...
k.qb = function () {
  if (this.ga) {
    ...
    0 < a && a < 0.8 * this.h
      ? (this.T = this.g.setTimeout(this.j, this.h - a))
...
function ic(a, b2) {
  ...
  a.u
    ? (a.v || (a.v = "POST"),
      ...
      a.g.ha(a.B, a.v, a.u, b2))
    : ((a.v = "GET"), a.g.ha(a.B, a.v, null, b2));
  Ob();
  ...
  try {
    if (a == this.g)
      a: {
        ...
        if (
          !(3 > u) &&
          (3 != u || va || (this.g && (this.h.h || this.g.ja() || mc(this.g))))
        ) {
          ...
          b: if (oc(this)) {
            ...
            for (b2 = 0; b2 < e; b2++)
              (this.h.h = true),
                (a += this.h.i.decode(d[b2], { stream: f && b2 == e - 1 }));
            d.length = 0;
            this.h.g += a;
            this.o = 0;
            h = this.h.g;
          ...
          if (this.i) {
            ...
            this.S
              ...
              : (D(this.j, this.m, h, null), qc(this, h));
            4 == u && I(this);
            this.i &&
              !this.J &&
              (4 == u ? sc(this.l, this) : ((this.i = false), jc(this)));
          } else
            tc(this.g),
  ...
  d
    ? 0 < c.length &&
      ...
      b2.g == a &&
        ...
        (b2.M = true),
        F(11)))
    : (D(a.j, a.m, c, "[Invalid Chunked Response]"), I(a), pc(a));
}
k.mb = function () {
  if (this.g) {
    var a = H(this.g),
      b2 = this.g.ja();
    this.o < b2.length &&
      (nc(this), rc(this, a, b2), this.i && 4 != a && jc(this));
  }
};
function uc(a, b2) {
  var c = a.o,
          ...
          if (2 == c.H)
            if ("c" == m[0]) {
              ...
              null != Ka &&
                ...
                ((d = 1.5 * Ka),
                (c.L = d),
                c.l.info("backChannelRequestTimeoutMs_=" + d));
              d = c;
              const la = a.g;
              if (la) {
                const La = la.g
                  ? la.g.getResponseHeader("X-Client-Wire-Protocol")
                  : null;
                if (La) {
                  var f = d.i;
                  f.g ||
                    ...
                    f.h && (Cc(f, f.h), (f.h = null)));
                }
                if (d.F) {
                  const Db = la.g
                    ? la.g.getResponseHeader("X-HTTP-Session-Id")
                    : null;
  ...
  if (a instanceof M) {
    ...
    a && (b2 = String(a).match(Lc))
      ? ((this.h = false),
        ...
        Qc(this, b2[6] || "", true),
        (this.o = Rc(b2[7] || "")))
      : ((this.h = false), (this.i = new Pc(null, this.h)));
}
M.prototype.toString = function () {
  ...
  if (c || "file" == b2)
    a.push("//"),
      (b2 = this.s) && a.push(Sc(b2, Tc, true), "@"),
      a.push(
  ...
  if ((c = this.l))
    this.g && "/" != c.charAt(0) && a.push("/"),
      a.push(Sc(c, "/" == c.charAt(0) ? Uc : Vc, true));
...
function Qc(a, b2, c) {
  b2 instanceof Pc
    ? ((a.i = b2), Xc(a.i, a.h))
    : (c || (b2 = Sc(b2, Yc)), (a.i = new Pc(b2, a.h)));
}
function K(a, b2, c) {
  a.i.set(b2, c);
}
...
k.ha = function (a, b2, c, d) {
  ...
  try {
    wd(this),
      0 < this.B &&
        ((this.L = xd(this.g))
          ? ((this.g.timeout = this.B), (this.g.ontimeout = q(this.ua, this)))
...
k.N = function () {
  this.g &&
    (this.h &&
      ((this.h = false), (this.l = true), this.g.abort(), (this.l = false)),
    zd(this, true));
  P.$.N.call(this);
};
k.La = function () {
        ...
        if (!(c = b2)) {
          ...
          if ((d = 0 === h)) {
            ...
            !e &&
              l.self &&
              l.self.location &&
              (e = l.self.location.protocol.slice(0, -1));
  ...
  if (this.m)
    if (((this.m = null), 1 == this.H)) {
      if (!a) {
        ...
        f &&
          (this.O
            ? (b2 = "headers=" + encodeURIComponent(String(Bd(f))) + "&" + b2)
            : this.o && Cd(c, this.o, f));
        Cc(this.i, e);
      ...
      3 == this.H &&
        (a ? Ld(this, a) : 0 == this.j.length || ed(this.i) || Ld(this));
};
function Ld(a, b2) {
  var c;
  b2 ? (c = b2.m) : (c = a.W++);
...
function J(a, b2) {
  ...
  if (2 == b2) {
    ...
    var d = q(a.pb, a);
    c ||
      ((c = new M("//www.google.com/images/cleardot.gif")),
      (l.location && "http" == l.location.protocol) || Nc(c, "https"),
      hc(c));
    jd(c.toString(), d);
  } else F(2);
  a.H = 0;
...
k.pb = function (a) {
  a
    ? (this.l.info("Successfully pinged google.com"), F(2))
    : (this.l.info("Failed to ping google.com"), F(1));
};
function Hd(a) {
  a.H = 0;
  a.ma = [];
...
function Q(a, b2) {
  ...
  b2 &&
    b2.Ca &&
    (a
      ? (a["X-WebChannel-Client-Profile"] = b2.Ca)
      : (a = { "X-WebChannel-Client-Profile": b2.Ca }));
  this.g.U = a;
...
function Sd(a, b2, c) {
  ...
  a.g[1] =
    (a.g[1] + (e + (((h << 21) & 4294967295) | (h >>> 11)))) & 4294967295;
...
S.prototype.l = function () {
  ...
  a = Array(16);
  for (b2 = c = 0; 4 > b2; ++b2)
    for (var d = 0; 32 > d; d += 8) a[c++] = (this.g[b2] >>> d) & 255;
  return a;
};
function T(a, b2) {
  this.h = b2;
...
function Vd(a, b2) {
  ...
  for (var c = U(Math.pow(b2, 8)), d = V, e = 0; e < a.length; e += 8) {
    var f = Math.min(8, a.length - e),
      h = parseInt(a.substring(e, e + f), b2);
    8 > f
      ? ((f = U(Math.pow(b2, f))), (d = d.R(f).add(U(h))))
      : ((d = d.R(c)), (d = d.add(U(h))));
  }
  return d;
}
...
k.add = function (a) {
  for (
    var b2 = Math.max(this.g.length, a.g.length), c = [], d = 0, e = 0;
    e <= b2;
    e++
  ) {
...
function Z(a, b2) {
  ...
  for (var d = a.g.length - c, e = [], f = 0; f < d; f++)
    e[f] =
      0 < b2 ? (a.D(f + c) >>> b2) | (a.D(f + c + 1) << (32 - b2)) : a.D(f + c);
  return new T(e, a.h);
}
    ...
    for (; r2 < e.length; ) {
      ...
      if ("\\" === t2) {
        ...
        "`" === t2
          ...
          : "." !== t2 || i
            ? ((n += t2), r2++)
            : (__PRIVATE_addCurrentSegment(), r2++);
    }
...
function __PRIVATE_fieldIndexSemanticComparator(e, t) {
  ...
  for (let r2 = 0; r2 < Math.min(e.fields.length, t.fields.length); ++r2)
    if (
      ((n = __PRIVATE_indexSegmentComparator(e.fields[r2], t.fields[r2])),
      0 !== n)
    )
      return n;
...
function __PRIVATE_newIndexOffsetSuccessorFromReadTime(e, t) {
  const n = e.toTimestamp().seconds,
    r2 = e.toTimestamp().nanoseconds + 1,
    i = SnapshotVersion.fromTimestamp(
      1e9 === r2 ? new Timestamp(n + 1, 0) : new Timestamp(n, r2),
    );
...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  static D() {
    ...
    const e = getUA(),
      ...
      n = 0 < t && t < 10,
      r2 = __PRIVATE_getAndroidVersion(e),
      i = 0 < r2 && r2 < 4.5;
    return !(
      e.indexOf("MSIE ") > 0 ||
      e.indexOf("Trident/") > 0 ||
  ...
  static C() {
    ...
    return (
      ...
      "YES" ===
        (null === (e = process.__PRIVATE_env) || void 0 === e ? void 0 : e.v)
    );
  }
          ...
          (this.db = yield new Promise((t, n) => {
            ...
            (r2.onsuccess = (e2) => {
              ...
              (r2.onerror = (t2) => {
                ...
                "VersionError" === r3.name
                  ? n(
                      new FirestoreError(
                        C2.FAILED_PRECONDITION,
                  ...
                  : "InvalidStateError" === r3.name
                    ...
                    : n(new __PRIVATE_IndexedDbTransactionError(e, r3));
              }),
              (r2.onupgradeneeded = (e2) => {
                ...
                this.p
                  .O(t2, r2.transaction, e2.oldVersion, this.version)
                  .next(() => {
                    __PRIVATE_logDebug(
                      "SimpleDb",
...
var __PRIVATE_IndexedDbTransactionError = class extends FirestoreError {
  constructor(e, t) {
    super(C2.UNAVAILABLE, `IndexedDB transaction '${e}' failed: ${t}`),
...
var __PRIVATE_SimpleDbStore = class {
  ...
  U(e, t) {
    const n = this.options(e, t),
      r2 = n.index ? this.store.index(n.index) : this.store;
    ...
    return new PersistencePromise((n, r2) => {
      (t.onerror = (e2) => {
        ...
        (t.onsuccess = (t2) => {
          ...
          r3
            ? e(r3.primaryKey, r3.value).next((e2) => {
                e2 ? r3.continue() : n();
              })
            : n();
        });
...
function __PRIVATE_checkForAndReportiOSError(e) {
  ...
  if (t >= 12.2 && t < 13) {
    ...
    if (e.message.indexOf(t2) >= 0) {
      ...
      return (
        M2 ||
          ((M2 = true), // Throw a global exception outside of this promise chain, for the user to
          // potentially catch.
          setTimeout(() => {
            throw e2;
          }, 0)),
...
var LLRBNode = class _LLRBNode {
  constructor(e, t, n, r2, i) {
    (this.key = e),
      ...
      (this.left = null != r2 ? r2 : _LLRBNode.EMPTY),
  ...
  insert(e, t, n) {
    ...
    return (
      (r2 =
        i < 0
          ? r2.copy(null, null, null, r2.left.insert(e, t, n), null)
          : 0 === i
            ? r2.copy(null, t, null, null, null)
            : r2.copy(null, null, null, null, r2.right.insert(e, t, n))),
      r2.fixUp()
    );
  }
  removeMin() {
  ...
  remove(e, t) {
    ...
    if (t(e, r2.key) < 0)
      r2.left.isEmpty() ||
        ...
        r2.left.left.isRed() ||
        (r2 = r2.moveRedLeft()),
        (r2 = r2.copy(null, null, null, r2.left.remove(e, t), null));
    else {
      if (
        (r2.left.isRed() && (r2 = r2.rotateRight()),
        r2.right.isEmpty() ||
          r2.right.isRed() ||
          r2.right.left.isRed() ||
          (r2 = r2.moveRedRight()),
        ...
        (n = r2.right.min()),
          (r2 = r2.copy(n.key, n.value, null, null, r2.right.removeMin()));
      }
    ...
    case 3:
      return (function __PRIVATE_timestampEquals(e2, t2) {
        ...
        const n2 = __PRIVATE_normalizeTimestamp(e2.timestampValue),
          r2 = __PRIVATE_normalizeTimestamp(t2.timestampValue);
      ...
      return (function __PRIVATE_numberEquals(e2, t2) {
        ...
        if ("doubleValue" in e2 && "doubleValue" in t2) {
          const n2 = __PRIVATE_normalizeNumber(e2.doubleValue),
            r2 = __PRIVATE_normalizeNumber(t2.doubleValue);
          return n2 === r2
            ? __PRIVATE_isNegativeZero(n2) === __PRIVATE_isNegativeZero(r2)
            : isNaN(n2) && isNaN(r2);
        }
        return false;
      })(e, t);
    ...
    case 2:
      return (function __PRIVATE_compareNumbers(e2, t2) {
        const n2 = __PRIVATE_normalizeNumber(e2.integerValue || e2.doubleValue),
          r3 = __PRIVATE_normalizeNumber(t2.integerValue || t2.doubleValue);
        return n2 < r3
          ? -1
          : n2 > r3
            ? 1
    ...
    case 6:
      return (function __PRIVATE_compareBlobs(e2, t2) {
        const n2 = __PRIVATE_normalizeByteString(e2),
          r3 = __PRIVATE_normalizeByteString(t2);
...
function __PRIVATE_compareTimestamps(e, t) {
  ...
  const n = __PRIVATE_normalizeTimestamp(e),
    r2 = __PRIVATE_normalizeTimestamp(t),
    i = __PRIVATE_primitiveComparator(n.seconds, r2.seconds);
...
var ObjectValue = class _ObjectValue {
  ...
  getFieldsMap(e) {
    ...
    for (let n = 0; n < e.length; ++n) {
      ...
      (__PRIVATE_isMapValue(r2) && r2.mapValue.fields) ||
        ((r2 = {
          mapValue: {
            fields: {},
          },
        }),
        (t.mapValue.fields[e.get(n)] = r2)),
        (t = r2);
    }
  ...
  return (
    forEach(e.fields, (e2, n) => {
      ...
      if (__PRIVATE_isMapValue(n)) {
        ...
        if (0 === e3.length) t.push(r2);
        else for (const n2 of e3) t.push(r2.child(n2));
      } else t.push(r2);
    }),
    new FieldMask(t)
  );
      ...
      ? (function __PRIVATE_compositeFilterEquals(e2, t2) {
          if (
            ...
            return e2.filters.reduce(
              (e3, n, r2) => e3 && __PRIVATE_filterEquals(n, t2.filters[r2]),
              true,
            );
          }
          return false;
  ...
  if (null === t.ce) {
    ...
    const n =
        t.explicitOrderBy.length > 0
          ...
          : "asc",
      r2 = (function __PRIVATE_getInequalityFilterFields(e3) {
    ...
    r2.forEach((r3) => {
      e2.has(r3.canonicalString()) ||
        r3.isKeyField() ||
        t.ce.push(new OrderBy(r3, n));
...
function __PRIVATE_compareDocs(e, t, n) {
  const r2 = e.field.isKeyField()
    ? DocumentKey.comparator(t.key, n.key)
    : (function __PRIVATE_compareDocumentsByField(e2, t2, n2) {
        const r3 = t2.data.field(e2),
          i = n2.data.field(e2);
        return null !== r3 && null !== i
          ? __PRIVATE_valueCompare(r3, i)
          : fail();
      })(e.field, t, n);
  switch (e.dir) {
    case "asc":
...
var ObjectMap = class {
  ...
  set(e, t) {
    ...
    for (let n2 = 0; n2 < r2.length; n2++)
      if (this.equalsFn(r2[n2][0], e)) return void (r2[n2] = [e, t]);
  ...
  delete(e) {
    ...
    for (let r2 = 0; r2 < n.length; r2++)
      if (this.equalsFn(n[r2][0], e))
        return (
          1 === n.length ? delete this.inner[t] : n.splice(r2, 1),
          this.innerSize--,
          true
        );
    return false;
      ...
      : e instanceof __PRIVATE_ArrayRemoveTransformOperation
        ...
        : (function __PRIVATE_applyNumericIncrementTransformOperationToLocalView(
            ...
            const n2 = __PRIVATE_computeTransformOperationBaseValue(e2, t2),
              r2 = asNumber(n2) + asNumber(e2.Pe);
            return isInteger(n2) && isInteger(e2.Pe)
              ? __PRIVATE_toInteger(r2)
              : __PRIVATE_toDouble(e2.serializer, r2);
          })(e, t);
}
    ...
    for (let e2 of t.fields)
      if (!i.has(e2)) {
        ...
        null === t2 &&
          ...
          null === t2 ? r2.delete(e2) : r2.set(e2, t2),
          (i = i.add(e2));
      }
...
function __PRIVATE_mutationApplyToRemoteDocument(e, t, n) {
  e instanceof __PRIVATE_SetMutation
    ? (function __PRIVATE_setMutationApplyToRemoteDocument(e2, t2, n2) {
        ...
        r2.setAll(i),
          t2.convertToFoundDocument(n2.version, r2).setHasCommittedMutations();
      })(e, t, n)
    : e instanceof __PRIVATE_PatchMutation
      ? (function __PRIVATE_patchMutationApplyToRemoteDocument(e2, t2, n2) {
          ...
          const r2 = __PRIVATE_serverTransformResults(
              e2.fieldTransforms,
              t2,
              n2.transformResults,
            ),
...
function __PRIVATE_mutationApplyToLocalView(e, t, n, r2) {
  return e instanceof __PRIVATE_SetMutation
    ? (function __PRIVATE_setMutationApplyToLocalView(e2, t2, n2, r3) {
        if (!__PRIVATE_preconditionIsValidForDocument(e2.precondition, t2))
          return n2;
        const i = e2.value.clone(),
          s = __PRIVATE_localTransformResults(e2.fieldTransforms, r3, t2);
        return (
          i.setAll(s),
    ...
    : e instanceof __PRIVATE_PatchMutation
      ? (function __PRIVATE_patchMutationApplyToLocalView(e2, t2, n2, r3) {
          if (!__PRIVATE_preconditionIsValidForDocument(e2.precondition, t2))
            return n2;
          const i = __PRIVATE_localTransformResults(e2.fieldTransforms, r3, t2),
            s = t2.data;
          if (
...
function __PRIVATE_mutationExtractBaseValue(e, t) {
  ...
  for (const r2 of e.fieldTransforms) {
    const e2 = t.data.field(r2.field),
      i = __PRIVATE_computeTransformOperationBaseValue(
        r2.transform,
        e2 || null,
      );
...
var MutationBatch = class {
  ...
  applyToLocalDocumentSet(e, t) {
    ...
    return (
      this.mutations.forEach((r2) => {
        const i = e.get(r2.key),
          s = i.overlayedDocument;
        let o = this.applyToLocalView(s, i.mutatedFields);
        o = t.has(r2.key) ? null : o;
        const _ = __PRIVATE_calculateOverlayMutation(s, o);
        null !== _ && n.set(r2.key, _),
...
((le = ce || (ce = {}))[(le.OK = 0)] = "OK"),
  (le[(le.CANCELLED = 1)] = "CANCELLED"),
  (le[(le.UNKNOWN = 2)] = "UNKNOWN"),
  (le[(le.INVALID_ARGUMENT = 3)] = "INVALID_ARGUMENT"),
  (le[(le.DEADLINE_EXCEEDED = 4)] = "DEADLINE_EXCEEDED"),
  (le[(le.NOT_FOUND = 5)] = "NOT_FOUND"),
  (le[(le.ALREADY_EXISTS = 6)] = "ALREADY_EXISTS"),
  (le[(le.PERMISSION_DENIED = 7)] = "PERMISSION_DENIED"),
  (le[(le.UNAUTHENTICATED = 16)] = "UNAUTHENTICATED"),
  (le[(le.RESOURCE_EXHAUSTED = 8)] = "RESOURCE_EXHAUSTED"),
  (le[(le.FAILED_PRECONDITION = 9)] = "FAILED_PRECONDITION"),
  (le[(le.ABORTED = 10)] = "ABORTED"),
  (le[(le.OUT_OF_RANGE = 11)] = "OUT_OF_RANGE"),
  (le[(le.UNIMPLEMENTED = 12)] = "UNIMPLEMENTED"),
  (le[(le.INTERNAL = 13)] = "INTERNAL"),
  (le[(le.UNAVAILABLE = 14)] = "UNAVAILABLE"),
  (le[(le.DATA_LOSS = 15)] = "DATA_LOSS");
var he = null;
...
var BloomFilter = class _BloomFilter {
  ...
  Ee(e, t, n) {
    ...
    return (
      1 === r2.compare(Pe) &&
        (r2 = new Integer([r2.getBits(0), r2.getBits(1)], 0)),
      r2.modulo(this.Te).toNumber()
    );
  }
  ...
  mightContain(e) {
    ...
    const t = __PRIVATE_getMd5HashValue(e),
      [n, r2] = __PRIVATE_get64BitUints(t);
  ...
  static create(e, t, n) {
    const r2 = e % 8 == 0 ? 0 : 8 - (e % 8),
      i = new Uint8Array(Math.ceil(e / 8)),
      s = new _BloomFilter(i, r2, t);
                ...
                h &&
                  (l2.bloomFilter = {
                    ...
                    mightContain: (e3) => {
                      ...
                      return (
                        null !==
                          (t3 = null == r4 ? void 0 : r4.mightContain(e3)) &&
                        void 0 !== t3 &&
                        t3
                      );
                    },
    ...
    this.Be.forEach((n2, r3) => {
      ...
      if (i) {
        if (n2.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
          ...
          null !== this.ke.get(t2) ||
            this.it(r3, t2) ||
            this.Ue(r3, t2, MutableDocument.newNoDocument(t2, e));
        }
  ...
  return "found" in t
    ? (function __PRIVATE_fromFound(e2, t2) {
        ...
        const n = fromName(e2, t2.found.name),
          r2 = __PRIVATE_fromVersion(t2.found.updateTime),
    ...
    : "missing" in t
      ? (function __PRIVATE_fromMissing(e2, t2) {
          ...
          const n = fromName(e2, t2.missing),
            r2 = __PRIVATE_fromVersion(t2.readTime);
...
function __PRIVATE_fromWatchChange(e, t) {
  ...
  if ("targetChange" in t) {
    ...
    const i = fromName(e, r2.document.name),
      s = __PRIVATE_fromVersion(r2.document.updateTime),
      o = r2.document.createTime
        ? __PRIVATE_fromVersion(r2.document.createTime)
        : SnapshotVersion.min(),
      _ = new ObjectValue({
        mapValue: {
    ...
    if (!("filter" in t)) return fail();
    {
      ...
      const e2 = t.filter;
      e2.targetId;
      const { count: r2 = 0, unchangedNames: i } = e2,
        s = new ExistenceFilter(r2, i),
        o = e2.targetId;
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  ...
  if (t.document)
    ...
    const e2 = DocumentKey.fromSegments(t.noDocument.path),
      r2 = __PRIVATE_fromDbTimestamp(t.noDocument.readTime);
    (n = MutableDocument.newNoDocument(e2, r2)),
    ...
    if (!t.unknownDocument) return fail();
    {
      const e2 = DocumentKey.fromSegments(t.unknownDocument.path),
        r2 = __PRIVATE_fromDbTimestamp(t.unknownDocument.version);
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  const n = (t.baseMutations || []).map((t2) =>
    __PRIVATE_fromMutation(e.ut, t2),
  );
  for (let e2 = 0; e2 < t.mutations.length - 1; ++e2) {
    ...
    if (
      ...
      (n2.updateTransforms = r3.transform.fieldTransforms),
        t.mutations.splice(e2 + 1, 1),
        ++e2;
    }
  }
  const r2 = t.mutations.map((t2) => __PRIVATE_fromMutation(e.ut, t2)),
...
function __PRIVATE_toDbTarget(e, t) {
  const n = __PRIVATE_toDbTimestamp(t.snapshotVersion),
    r2 = __PRIVATE_toDbTimestamp(t.lastLimboFreeSnapshotVersion);
  let i;
  i = __PRIVATE_targetIsDocumentTarget(t.target)
    ? __PRIVATE_toDocumentsTarget(e.ut, t.target)
    : __PRIVATE_toQueryTarget(e.ut, t.target)._t;
...
var __PRIVATE_IndexedDbDocumentOverlayCache = class ___PRIVATE_IndexedDbDocumentOverlayCache {
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    t.forEach((e2) =>
      r2.add(__PRIVATE_encodeResourcePath(e2.getCollectionPath())),
    );
    const i = [];
    return (
      r2.forEach((t2) => {
        ...
        i.push(
          __PRIVATE_documentOverlayStore(e).j("collectionPathOverlayIndex", r3),
        );
      }),
        ...
        : t instanceof FieldFilter
          ...
          : (function __PRIVATE_applyDistributionCompositeFilters(e2, t2) {
              ...
              const n2 = __PRIVATE_compositeFilterIsDisjunction(e2) ? e2 : t2,
                r2 = __PRIVATE_compositeFilterIsDisjunction(e2) ? t2 : e2,
                i = n2.filters.map((e3) => __PRIVATE_applyDistribution(e3, r2));
              return CompositeFilter.create(
                i,
                "or",
                /* CompositeOperator.OR */
...
var __PRIVATE_MemoryCollectionParentIndex = class {
  ...
  add(e) {
    const t = e.lastSegment(),
      n = e.popLast(),
      r2 = this.index[t] || new SortedSet(ResourcePath.comparator),
      i = !r2.has(n);
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  addFieldIndex(e, t) {
    const n = __PRIVATE_indexConfigurationStore(e),
      r2 = (function __PRIVATE_toDbIndexConfiguration(e2) {
        return {
          indexId: e2.indexId,
  ...
  deleteFieldIndex(e, t) {
    const n = __PRIVATE_indexConfigurationStore(e),
      r2 = __PRIVATE_indexStateStore(e),
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.un(t), (t2) =>
      ...
      if (r2) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = (function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            l2 = this.ln(i2, s, u),
            h = this.hn(i2, s, _),
            P2 = this.Pn(i2.indexId, o, c, a.inclusive, l2, u.inclusive, h);
          return PersistencePromise.forEach(P2, (i3) =>
  ...
  Pn(e, t, n, r2, i, s, o) {
    const _ = (null != t ? t.length : 1) * Math.max(n.length, i.length),
      ...
      u = [];
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.In(t[c / a]) : de,
        l2 = this.Tn(e, _2, n[c % a], r2),
  ...
  cn(e, t) {
    const n = new __PRIVATE_TargetIndexMatcher(t),
      r2 = null != t.collectionGroup ? t.collectionGroup : t.path.lastSegment();
  ...
  getIndexType(e, t) {
    let n = 2;
    const r2 = this.un(t);
    return PersistencePromise.forEach(r2, (t2) =>
      this.cn(e, t2).next((e2) => {
        e2
          ? 0 !== n &&
            e2.fields.length <
  ...
  hn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r2)
        if (this.Rn(t, s.fieldPath) && isArray(e2)) r2 = this.Vn(r2, s, e2);
        else {
  ...
  Vn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || [])
      for (const n2 of r2) {
        ...
        r3.seed(n2.Ut()),
          __PRIVATE_FirestoreIndexValueWriter.St.ht(e2, r3.jt(t.kind)),
          i.push(r3);
      }
    return i;
  }
  ...
  getFieldIndexes(e, t) {
    ...
    return (
      ...
      return PersistencePromise.forEach(e2, (e3) =>
        r2.get([e3.indexId, this.uid]).next((n2) => {
          t2.push(
  ...
  updateCollectionGroup(e, t, n) {
    const r2 = __PRIVATE_indexConfigurationStore(e),
      i = __PRIVATE_indexStateStore(e);
    return this.fn(e).next((e2) =>
      r2
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(
            new __PRIVATE_IndexEntry(t.indexId, e.key, this.In(i2), r2),
          );
  ...
  yn(e, t, n, r2, i) {
    ...
    const s = [];
    return (
      (function __PRIVATE_diffSortedSets(e2, t2, n2, r3, i2) {
        ...
        for (; _ || a; ) {
          ...
          e3
            ? (r3(a), (a = __PRIVATE_advanceIterator(o)))
            : t3
  ...
  createRange(e, t, n) {
    ...
    for (const i2 of n) {
      ...
      if (0 === n2) r2[0] = e.Ht();
      else if (n2 > 0 && s < 0) r2.push(i2), r2.push(i2.Ht());
      else if (s > 0) break;
    }
    r2.push(t);
    const i = [];
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.un(t), (t2) =>
      this.cn(e, t2).next((e2) => e2 || fail()),
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    return s.add({}).next((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r2),
        a = (function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
          const r3 = n2.baseMutations.map((t3) => toMutation(e2.ut, t3)),
  ...
  getNextMutationBatchAfterBatchId(e, t) {
    const n = t + 1,
      r2 = IDBKeyRange.lowerBound([this.userId, n]);
    let i = null;
    return __PRIVATE_mutationsStore(e)
      .J(
        {
...
function __PRIVATE_mutationQueueContainsKey(e, t, n) {
  const r2 = __PRIVATE_newDbDocumentMutationPrefixForPath(t, n.path),
    i = r2[1],
    s = IDBKeyRange.lowerBound(r2);
  let o = false;
  return __PRIVATE_documentMutationsStore(e)
    .J(
      {
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  setTargetsMetadata(e, t, n) {
    return this.Ln(e).next(
      (r2) => (
        (r2.highestListenSequenceNumber = t),
        n && (r2.lastRemoteSnapshotVersion = n.toTimestamp()),
        t > r2.highestListenSequenceNumber &&
          (r2.highestListenSequenceNumber = t),
        this.Bn(e, r2)
      ),
    );
  ...
  addTargetData(e, t) {
    return this.kn(e, t).next(() =>
      this.Ln(e).next(
        (n) => ((n.targetCount += 1), this.qn(t, n), this.Bn(e, n)),
      ),
    );
  }
    ...
    return __PRIVATE_targetsStore(e)
      .J((s, o) => {
        ...
        _.sequenceNumber <= t &&
          ...
          (r2++, i.push(this.removeTargetData(e, _)));
      })
  ...
  getMatchingKeysForTargetId(e, t) {
    ...
    return r2
      .J(
        ...
        (e2, t2, n2) => {
          const r3 = __PRIVATE_decodeResourcePath(e2[1]),
            s = new DocumentKey(r3);
          i = i.add(s);
        },
      )
      .next(() => i);
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  nthSequenceNumber(e, t) {
    ...
    return this.zn
      .forEachTarget(e, (e2) => n.Un(e2.sequenceNumber))
      .next(() => this.zn.Hn(e, (e2) => n.Un(e2)))
      .next(() => n.maxValue);
  }
  removeTargets(e, t, n) {
  ...
  Jn(e, t) {
          ...
          (
            ...
            t2 > this.params.maximumSequenceNumbersToCollect
              ? (__PRIVATE_logDebug(
                ...
                (r2 = this.params.maximumSequenceNumbersToCollect))
              : (r2 = t2),
            (s = Date.now()),
            this.nthSequenceNumber(e, r2)
          ),
      )
      .next((r3) => ((n = r3), (o = Date.now()), this.removeTargets(e, n, t)))
      .next(
        (t2) => (
          (i = t2), (a = Date.now()), this.removeOrphanedDocuments(e, n)
        ),
      )
      .next((e2) => {
	...
	Determined least recently used ${r2} in ` +
              (o - s) +
              `ms
...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  Xn(e, t) {
    return (function __PRIVATE_mutationQueuesContainKey(e2, t2) {
      ...
      return __PRIVATE_mutationQueuesStore(e2)
        .Y((r2) =>
          __PRIVATE_mutationQueueContainsKey(e2, r2, t2).next(
  ...
  Zn(e, t) {
    ...
    return n
        ...
        ([e2, n2], { path: s, sequenceNumber: o }) => {
          0 === e2
            ? // if nextToReport is valid, report it, this is a new key so the
              ...
              (i !== __PRIVATE_ListenSequence.oe &&
                t(new DocumentKey(__PRIVATE_decodeResourcePath(r2)), i), // set nextToReport to be this sequence number. It's the next one we
      ...
      .next(() => {
        i !== __PRIVATE_ListenSequence.oe &&
          t(new DocumentKey(__PRIVATE_decodeResourcePath(r2)), i);
      });
  }
  getCacheSize(e) {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  ir(e, t) {
    let n = __PRIVATE_mutableDocumentMap(),
      r2 = new SortedMap(DocumentKey.comparator);
    return this.rr(e, t, (e2, t2) => {
  ...
  rr(e, t, n) {
    ...
    const i = IDBKeyRange.bound(
        __PRIVATE_dbKey(r2.first()),
        __PRIVATE_dbKey(r2.last()),
      ),
      s = r2.getIterator();
    let o = s.getNext();
    return __PRIVATE_remoteDocumentsStore(e)
    ...
    return __PRIVATE_remoteDocumentsStore(e)
      ...
      .next((e2) => {
        ...
        for (const i2 of e2) {
          ...
          e3.isFoundDocument() &&
            (__PRIVATE_queryMatches(t, e3) || r2.has(e3.key)) && // Either the document matches the given query, or it is mutated.
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((i, s) => {
        ...
        if (
          (t.push(this._r.removeEntry(e, i, o.readTime)), s.isValidDocument())
        ) {
...
function __PRIVATE_dbKeyComparator(e, t) {
  ...
  for (let e2 = 0; e2 < n.length - 2 && e2 < r2.length - 2; ++e2)
    if (((i = __PRIVATE_primitiveComparator(n[e2], r2[e2])), i)) return i;
  return (
    (i = __PRIVATE_primitiveComparator(n.length, r2.length)),
    i ||
      ((i = __PRIVATE_primitiveComparator(n[n.length - 2], r2[r2.length - 2])),
      i || __PRIVATE_primitiveComparator(n[n.length - 1], r2[r2.length - 1]))
  );
}
...
var LocalDocumentsView = class {
  ...
  getDocument(e, t) {
    ...
    return this.documentOverlayCache
      .getOverlay(e, t)
      .next((r2) => ((n = r2), this.remoteDocumentCache.getEntry(e, t)))
      .next(
        (e2) => (
          null !== n &&
  ...
  getLocalViewOfDocuments(e, t, n = __PRIVATE_documentKeySet()) {
    const r2 = __PRIVATE_newOverlayMap();
    return this.populateOverlays(e, r2, t).next(() =>
      this.computeViews(e, t, r2, n).next((e2) => {
        let t2 = documentMap();
        return (
          e2.forEach((e3, n2) => {
  ...
  recalculateAndSaveOverlays(e, t) {
    ...
    let r2 = new SortedMap((e2, t2) => e2 - t2),
    ...
    return this.mutationQueue
      ...
      .next((e2) => {
        for (const i2 of e2)
          i2.keys().forEach((e3) => {
            ...
            const _ = (r2.get(i2.batchId) || __PRIVATE_documentKeySet()).add(
              e3,
            );
      ...
      .next(() => {
        ...
        for (; o.hasNext(); ) {
          ...
          a.forEach((e2) => {
            if (!i.has(e2)) {
              const r4 = __PRIVATE_calculateOverlayMutation(
                t.get(e2),
                n.get(e2),
              );
  ...
  getDocumentsMatchingQuery(e, t, n, r2) {
    return (function __PRIVATE_isDocumentQuery$1(e2) {
      ...
      : __PRIVATE_isCollectionGroupQuery(t)
        ? this.getDocumentsMatchingCollectionGroupQuery(e, t, n, r2)
        : this.getDocumentsMatchingCollectionQuery(e, t, n, r2);
  }
  /**
  ...
  getDocumentsMatchingCollectionGroupQuery(e, t, n, r2) {
    ...
    return this.indexManager.getCollectionParents(e, i).next((o) =>
      PersistencePromise.forEach(o, (o2) => {
        ...
        return this.getDocumentsMatchingCollectionQuery(e, _, n, r2).next(
          (e2) => {
            e2.forEach((e3, t2) => {
              s = s.insert(e3, t2);
            });
  ...
  getDocumentsMatchingCollectionQuery(e, t, n, r2) {
    ...
    return this.documentOverlayCache
      ...
      .next(
        (s) => (
          (i = s),
          this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, i, r2)
        ),
      )
      .next((e2) => {
        i.forEach((t2, n3) => {
          const r3 = n3.getKey();
          null === e2.get(r3) &&
            (e2 = e2.insert(r3, MutableDocument.newInvalidDocument(r3)));
        });
        let n2 = documentMap();
        return (
          e2.forEach((e3, r3) => {
...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    return (
      void 0 !== r2 &&
        (r2.forEach((e2) => (this.overlays = this.overlays.remove(e2))),
        this.lr.delete(n)),
      PersistencePromise.resolve()
    );
  }
  ...
  getOverlaysForCollectionGroup(e, t, n, r2) {
    ...
    for (; _.hasNext(); ) {
      if (
        (_.getNext().value.forEach((e2, t2) => o.set(e2, t2)), o.size() >= r2)
      )
        break;
    }
  ...
  lt(e, t, n) {
    ...
    let i = this.lr.get(t);
    void 0 === i && ((i = __PRIVATE_documentKeySet()), this.lr.set(t, i)),
...
var __PRIVATE_ReferenceSet = class {
  ...
  Rr(e) {
    const t = new DocumentKey(new ResourcePath([])),
      ...
      r2 = new __PRIVATE_DocReference(t, e + 1),
      i = [];
    return (
      this.Ir.forEachInRange([n, r2], (e2) => {
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    for (const t2 of r2)
      (this.yr = this.yr.add(new __PRIVATE_DocReference(t2.key, i))),
  ...
  getAllMutationBatchesAffectingDocumentKey(e, t) {
    const n = new __PRIVATE_DocReference(t, 0),
      r2 = new __PRIVATE_DocReference(t, Number.POSITIVE_INFINITY),
      i = [];
    return (
      this.yr.forEachInRange([n, r2], (e2) => {
    ...
    return (
      t.forEach((e2) => {
        const t2 = new __PRIVATE_DocReference(e2, 0),
          r2 = new __PRIVATE_DocReference(e2, Number.POSITIVE_INFINITY);
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return (
      ...
      PersistencePromise.resolve(this.br(o))
    );
  }
  br(e) {
    const t = [];
  ...
  removeMutationBatch(e, t) {
    ...
    return PersistencePromise.forEach(t.mutations, (r2) => {
      ...
      return (
        (n = n.delete(i)),
        this.referenceDelegate.markPotentiallyOrphaned(e, r2.key)
      );
    }).next(() => {
      this.yr = n;
    });
  ...
  containsKey(e, t) {
    const n = new __PRIVATE_DocReference(t, 0),
      r2 = this.yr.firstAfterOrEqual(n);
  ...
  getDocumentsMatchingQuery(e, t, n, r2) {
    ...
    for (; _.hasNext(); ) {
      ...
      e2.path.length > s.length + 1 ||
        ...
        ((r2.has(o2.key) || __PRIVATE_queryMatches(t, o2)) &&
...
var __PRIVATE_MemoryRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  ...
  applyChanges(e) {
    const t = [];
    return (
      this.changes.forEach((n, r2) => {
        r2.isValidDocument()
          ? t.push(this._r.addEntry(e, r2))
...
var __PRIVATE_MemoryTargetCache = class {
  ...
  removeMatchingKeys(e, t, n) {
    this.Or.Ar(t, n);
    const r2 = this.persistence.referenceDelegate,
      i = [];
    return (
      r2 &&
        t.forEach((t2) => {
...
var __PRIVATE_MemoryPersistence = class {
  ...
  constructor(e, t) {
    ...
    (this.indexManager = new __PRIVATE_MemoryIndexManager()),
      (this.remoteDocumentCache =
        ...
        })((e2) => this.referenceDelegate.Qr(e2))),
  ...
  runTransaction(e, t, n) {
    ...
    return (
      ...
      n(r2)
        .next((e2) => this.referenceDelegate.Ur(r2).next(() => e2))
        .toPromise()
        .then((e2) => (r2.raiseOnCommittedEvent(), e2))
    );
  }
  Wr(e, t) {
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  ...
  Hn(e, t) {
    return PersistencePromise.forEach(this.Yr, (n, r2) =>
      this.Xn(e, n, r2).next((e2) =>
        e2 ? PersistencePromise.resolve() : t(r2),
      ),
    );
  }
  removeTargets(e, t, n) {
  ...
  removeOrphanedDocuments(e, t) {
    let n = 0;
    const r2 = this.persistence.getRemoteDocumentCache(),
      i = r2.newChangeBuffer();
    return r2
      .vr(e, (r3) =>
        this.Xn(e, r3, t).next((e2) => {
...
var __PRIVATE_SchemaConverter = class {
  ...
  O(e, t, n, r2) {
    ...
    return (
      n < 3 &&
        r2 >= 3 && // Brand new clients don't need to drop and recreate--only clients that
            ...
            (function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(
              ...
              return t2
                ...
                .next((n2) => {
                  ...
                  const r3 = t2.store("mutations"),
                    i2 = n2.map((e3) => r3.put(e3));
      ...
      n < 7 && r2 >= 7 && (s = s.next(() => this.ei(i))),
      n < 8 && r2 >= 8 && (s = s.next(() => this.ti(e, i))),
      n < 9 &&
        r2 >= 9 &&
        (s = s.next(() => {
          ...
          .next(() =>
            (function __PRIVATE_createRemoteDocumentCache(e2) {
              ...
              t2.createIndex("documentKeyIndex", L),
                t2.createIndex("collectionGroupIndex", B2);
            })(e),
          )
          .next(() => this.ri(e, i))
          .next(() => e.deleteObjectStore("remoteDocuments"))),
      n < 14 && r2 >= 14 && (s = s.next(() => this.ii(e, i))),
      n < 15 &&
        r2 >= 15 &&
        (s = s.next(() =>
      ...
      n < 16 &&
        r2 >= 16 && // Clear the object stores to remove possibly corrupted index entries
        (s = s
          .next(() => {
  ...
  Zr(e) {
    ...
    return t.U().next((t2) =>
      PersistencePromise.forEach(t2, (t3) => {
        ...
        return n.U("userMutationsIndex", r2).next((n2) =>
  ...
  ti(e, t) {
    ...
    const n = t.store("collectionParents"),
      r2 = new __PRIVATE_MemoryCollectionParentIndex(),
      addEntry = (e2) => {
        if (r2.add(e2)) {
  ...
  ni(e) {
    ...
    return t.J((e2, n) => {
      const r2 = __PRIVATE_fromDbTarget(n),
        i = __PRIVATE_toDbTarget(this.serializer, r2);
      return t.put(i);
    });
  }
  ri(e, t) {
  ...
  ii(e, t) {
    const n = t.store("mutations"),
      r2 = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer),
      ...
      return (
        ...
        PersistencePromise.forEach(n2, (e3, n3) => {
          const s = new User(n3),
            ...
            a = __PRIVATE_IndexedDbMutationQueue.ct(
              s,
              this.serializer,
              _,
              i.referenceDelegate,
            );
          return new LocalDocumentsView(r2, a, o, _)
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 16) {
    ...
    (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r2)),
      (this.Ii = t + "main"),
  ...
  di() {
          ...
          .next(() => {
            if (this.isPrimary)
              return this.fi(e).next((e2) => {
                e2 ||
                  ((this.isPrimary = false),
                  this.si.enqueueRetryable(() => this.Pi(false)));
              });
          })
          .next(() => this.gi(e))
          .next((t) =>
            this.isPrimary && !t
              ? this.pi(e).next(() => false)
              : !!t && this.yi(e).next(() => true),
          ),
    )
      .catch((e) => {
    ...
    return __PRIVATE_primaryClientStore(e)
      .get("owner")
      .next((e2) => PersistencePromise.resolve(this.wi(e2)));
  }
  Si(e) {
          ...
          (e2) => {
            ...
            return t.U().next((e3) => {
              const n = this.Ci(e3, 18e5),
                r2 = e3.filter((e4) => -1 === n.indexOf(e4));
              return PersistencePromise.forEach(r2, (e4) =>
  ...
  shutdown() {
    return __async(this, null, function* () {
      (this.kr = false),
        ...
        this.xi(),
        this.Oi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
        // has obtained the primary lease.
        yield this.Ti.runTransaction(
          "shutdown",
          "readwrite",
  ...
  Ci(e, t) {
    return e.filter(
      (e2) => this.Di(e2.updateTimeMs, t) && !this.Fi(e2.clientId),
    );
  }
  /**
  ...
  Li() {
    return this.runTransaction("getActiveClients", "readonly", (e) =>
      __PRIVATE_clientMetadataStore(e)
        .U()
        .next((e2) => this.Ci(e2, 18e5).map((e3) => e3.clientId)),
    );
  }
  get started() {
    return this.kr;
  ...
  runTransaction(e, t, n) {
    ...
    const r2 = "readonly" === t ? "readonly" : "readwrite",
      i =
    ...
    return this.Ti.runTransaction(
      ...
      (r3) => (
        (s = new __PRIVATE_IndexedDbTransaction(
          r3,
          this.Br ? this.Br.next() : __PRIVATE_ListenSequence.oe,
        )),
        "readwrite-primary" === t
          ? this.fi(s)
              .next((e2) => !!e2 || this.gi(s))
              .next((t2) => {
                if (!t2)
                  throw (
                    (__PRIVATE_logError(
                    ...
                    (this.isPrimary = false),
                    this.si.enqueueRetryable(() => this.Pi(false)),
                    new FirestoreError(C2.FAILED_PRECONDITION, F2))
                  );
                return n(s);
              })
              .next((e2) => this.yi(s).next(() => e2))
          : this.Bi(s).next(() => n(s))
      ),
  ...
  Bi(e) {
    return __PRIVATE_primaryClientStore(e)
      ...
      .next((e2) => {
        if (
          null !== e2 &&
          this.Di(e2.leaseTimestampMs, 5e3) &&
          !this.Fi(e2.ownerId) &&
          !this.wi(e2) &&
          !(
            this._i ||
...
var __PRIVATE_QueryEngine = class {
  ...
  Ji(e, t, n, r2) {
    return n.documentReadCount < this.Ui
      ...
      : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG &&
        ...
        n.documentReadCount > this.Wi * r2
          ? (__PRIVATE_getLogLevel() <= LogLevel.DEBUG &&
              __PRIVATE_logDebug(
                "QueryEngine",
  ...
  zi(e, t) {
    ...
    return this.indexManager.getIndexType(e, n).next((r2) =>
      0 === r2
        ? null
        : (null !== t.limit &&
            1 === r2 && // We cannot apply a limit for targets that are served using a partial
          ...
          this.indexManager.getDocumentsMatchingTarget(e, n).next((r3) => {
            const i = __PRIVATE_documentKeySet(...r3);
            return this.Gi.getDocuments(e, i).next((r4) =>
              this.indexManager.getMinOffset(e, n).next((n2) => {
                const s = this.Yi(t, r4);
                return this.Zi(t, s, i, n2.readTime)
                  ? this.zi(
                      e,
                      __PRIVATE_queryWithLimit(
                        t,
   ...
   */
  Xi(e, t, n, r2) {
    return this.Gi.getDocumentsMatchingQuery(e, n, r2).next(
      (e2) =>
        (
    ...
    return yield n.persistence.runTransaction(
      ...
      (e2) => {
        ...
        return n.mutationQueue
          ...
          .next(
            (i) => (
              (r2 = i), n.os(t), n.mutationQueue.getAllMutationBatches(e2)
            ),
          )
          .next((t2) => {
            const i = [],
  ...
  return n.persistence.runTransaction(
    ...
    (e2) => {
      ...
      return (function __PRIVATE_applyWriteToRemoteDocuments(e3, t2, n2, r3) {
        ...
        .next(() => n.localDocuments.getDocuments(e2, r2));
    },
  );
}
  ...
  return n.persistence
    .runTransaction("Apply remote event", "readwrite-primary", (e2) => {
      ...
      t.targetChanges.forEach((s2, _2) => {
        ...
        o.push(
          n.qr
            .removeMatchingKeys(e2, s2.removedDocuments, _2)
            .next(() => n.qr.addMatchingKeys(e2, s2.addedDocuments, _2)),
        );
        ...
        null !== t.targetMismatches.get(_2)
          ...
          : s2.resumeToken.approximateByteSize() > 0 &&
            (u = u.withResumeToken(s2.resumeToken, r2)),
      ...
      if (
        (t.documentUpdates.forEach((r3) => {
          t.resolvedLimboDocuments.has(r3) &&
            o.push(n.persistence.referenceDelegate.updateLimboDocument(e2, r3));
        ...
        const t2 = n.qr
          ...
          .next((t3) =>
            n.qr.setTargetsMetadata(e2, e2.currentSequenceNumber, r2),
          );
        o.push(t2);
      }
...
function __PRIVATE_populateDocumentChangeBuffer(e, t, n) {
  let r2 = __PRIVATE_documentKeySet(),
    i = __PRIVATE_documentKeySet();
  return (
    n.forEach((e2) => (r2 = r2.add(e2))),
    t.getEntries(e, r2).next((e2) => {
          ...
          s.isFoundDocument() !== o.isFoundDocument() && (i = i.add(n2)), // Note: The order of the steps below is important, since we want
            ...
            s.isNoDocument() && s.version.isEqual(SnapshotVersion.min())
              ...
              : !o.isValidDocument() ||
                ...
                ? (t.addEntry(s), (r3 = r3.insert(n2, s)))
                : __PRIVATE_logDebug(
                    "LocalStore",
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (e2) => {
      let r2;
      return n.qr.getTargetData(e2, t).next((i) =>
        i
          ...
          : n.qr
              ...
              .next(
                (i2) => (
                  ...
                  n.qr.addTargetData(e2, r2).next(() => r2)
                ),
              ),
      );
    })
    .then((e2) => {
      ...
      return (
        (null === r2 || e2.snapshotVersion.compareTo(r2.snapshotVersion) > 0) &&
          ((n.ts = n.ts.insert(e2.targetId, e2)), n.ns.set(t, e2.targetId)),
        e2
      );
    });
}
function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  return __async(this, null, function* () {
    ...
    try {
      n ||
        (yield r2.persistence.runTransaction("Release target", s, (e2) =>
          r2.persistence.referenceDelegate.removeTarget(e2, i),
        ));
    } catch (e2) {
    ...
    (e2) =>
      (function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
        const r3 = __PRIVATE_debugCast(e3),
          i2 = r3.ns.get(n2);
        return void 0 !== i2
          ? PersistencePromise.resolve(r3.ts.get(i2))
          : r3.qr.getTargetData(t2, n2);
      })(r2, e2, __PRIVATE_queryToTarget(t))
        .next((t2) => {
          if (t2)
            return (
              (i = t2.lastLimboFreeSnapshotVersion),
              r2.qr.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
                s = e3;
              })
            );
        })
        .next(() =>
          r2.es.getDocumentsMatchingQuery(
            e2,
            t,
        ...
        .next(
          (e3) => (
            __PRIVATE_setMaxReadTime(r2, __PRIVATE_queryCollectionGroup(t), e3),
            {
              documents: e3,
              ls: s,
            }
    ...
    return i.persistence.runTransaction(
      ...
      (e2) =>
        __PRIVATE_populateDocumentChangeBuffer(e2, _, o)
          ...
          .next((t2) =>
            i.qr
              .removeMatchingKeysForTargetId(e2, a.targetId)
              .next(() => i.qr.addMatchingKeys(e2, s, a.targetId))
              .next(() =>
                i.localDocuments.getLocalViewOfDocuments(e2, t2.us, t2.cs),
              )
              .next(() => t2.us),
          ),
    );
...
function __PRIVATE_localStoreSaveNamedQuery(_0, _1) {
  return __async(
    ...
    function* (e, t, n = __PRIVATE_documentKeySet()) {
      const r2 = yield __PRIVATE_localStoreAllocateTarget(
          e,
      ...
      return i.persistence.runTransaction(
        ...
        (e2) => {
          ...
          return (
            (i.ts = i.ts.insert(o.targetId, o)),
            i.qr
              .updateTargetData(e2, o)
              .next(() => i.qr.removeMatchingKeysForTargetId(e2, r2.targetId))
              .next(() => i.qr.addMatchingKeys(e2, n, r2.targetId))
              .next(() => i.Kr.saveNamedQuery(e2, t))
          );
        },
      );
    },
...
var __PRIVATE_MutationMetadata = class ___PRIVATE_MutationMetadata {
  ...
  static Ts(e, t, n) {
    ...
    let i,
      s =
        "object" == typeof r2 &&
        -1 !== ["pending", "acknowledged", "rejected"].indexOf(r2.state) &&
        (void 0 === r2.error || "object" == typeof r2.error);
    return (
      s &&
        r2.error &&
        ((s =
          "string" == typeof r2.error.message &&
          "string" == typeof r2.error.code),
        s && (i = new FirestoreError(r2.error.code, r2.error.message))),
      s
        ? new ___PRIVATE_MutationMetadata(e, t, r2.state, i)
        : (__PRIVATE_logError(
            "SharedClientState",
  ...
  static Ts(e, t) {
    ...
    return (
      i &&
        ...
        i && (r2 = new FirestoreError(n.error.code, n.error.message))),
      i
        ? new ___PRIVATE_QueryTargetMetadata(e, n.state, r2)
        : (__PRIVATE_logError(
            "SharedClientState",
...
var __PRIVATE_RemoteClientState = class ___PRIVATE_RemoteClientState {
  ...
  static Ts(e, t) {
    const n = JSON.parse(t);
    let r2 = "object" == typeof n && n.activeTargetIds instanceof Array,
      i = __PRIVATE_targetIdSet();
    for (let e2 = 0; r2 && e2 < n.activeTargetIds.length; ++e2)
      (r2 = isSafeInteger(n.activeTargetIds[e2])),
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    ...
    (this.storage = this.window.localStorage),
      ...
      (this.Ss = new RegExp(`^firestore_clients_${s}_([^_]*)$`)),
      (this.bs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`)),
      (this.Ds = new RegExp(`^firestore_targets_${s}_(\\d+)$`)),
      (this.Cs =
        /** Assembles the key for the online state of the primary tab. */
        (function createWebStorageOnlineStateKey(e2) {
          return `firestore_online_state_${e2}`;
        })(this.persistenceKey)),
      (this.vs = (function createBundleLoadedKey(e2) {
  ...
  Ns(e, t, n) {
    const r2 = new __PRIVATE_MutationMetadata(this.currentUser, e, t, n),
  ...
  ks(e, t, n) {
    const r2 = createWebStorageQueryTargetMetadataKey(this.persistenceKey, e),
...
function __PRIVATE_generateUniqueDebugId() {
  return (
    null === Ve
      ? (Ve = (function __PRIVATE_generateInitialUniqueDebugId() {
  ...
  class __PRIVATE_RestConnection {
    constructor(e) {
      ...
      const t = e.ssl ? "https" : "http",
        ...
        r2 = encodeURIComponent(this.databaseId.database);
      (this.yo = t + "://" + e.host),
        (this.wo = `projects/${n}/databases/${r2}`),
        (this.So =
          "(default)" === this.databaseId.database
            ? `project_id=${n}`
            : `project_id=${n}&database_id=${r2}`);
    }
    get bo() {
      return false;
    }
    Do(e, t, n, r2, i) {
      const s = __PRIVATE_generateUniqueDebugId(),
        o = this.Co(e, t.toUriEncodedString());
  ...
  }
{
  ...
  Fo(e, t, n, r2) {
    ...
    return new Promise((s, o) => {
          ...
          try {
            switch (_.getLastErrorCode()) {
              ...
              case ErrorCode.TIMEOUT:
                __PRIVATE_logDebug(fe, `RPC '${e}' ${i} timed out`),
                  o(
                    new FirestoreError(
                      C2.DEADLINE_EXCEEDED,
                      "Request time out",
                    ),
                  );
                break;
                  ...
                  if (t3 && t3.status && t3.message) {
                    const e3 =
                      (function __PRIVATE_mapCodeFromHttpResponseErrorStatus(
                        ...
                        return Object.values(C2).indexOf(t4) >= 0
                          ? t4
                          : C2.UNKNOWN;
                      })(t3.status);
      ...
      __PRIVATE_logDebug(fe, `RPC '${e}' ${i} sending request:`, r2),
        _.send(t, "POST", a, n, 15);
    });
  }
  xo(e, t, n) {
    const r2 = __PRIVATE_generateUniqueDebugId(),
      i = [this.yo, "/", "google.firestore.v1.Firestore", "/", e, "/channel"],
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)),
      ...
      this.vo(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    const P2 = new __PRIVATE_StreamBridge({
        co: (t2) => {
          h
            ? __PRIVATE_logDebug(
                fe,
                `Not sending because RPC '${e}' stream ${r2} is closed:`,
                t2,
              )
            : (l2 ||
                (__PRIVATE_logDebug(
                  fe,
                  `Opening RPC '${e}' stream ${r2} transport.`,
                ),
                c.open(),
                (l2 = true)),
              __PRIVATE_logDebug(fe, `RPC '${e}' stream ${r2} sending:`, t2),
              c.send(t2));
        },
        lo: () => c.close(),
      }),
    ...
    return (
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
        h ||
          (__PRIVATE_logDebug(fe, `RPC '${e}' stream ${r2} transport opened.`),
          P2.Vo());
      }),
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.CLOSE, () => {
        h ||
          ((h = true),
          __PRIVATE_logDebug(fe, `RPC '${e}' stream ${r2} transport closed`),
          P2.fo());
      }),
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, (t2) => {
        h ||
          ...
          __PRIVATE_logWarn(
            fe,
            `RPC '${e}' stream ${r2} transport errored:`,
            t2,
          ),
          P2.fo(
            new FirestoreError(
      ...
      __PRIVATE_unguardedEventListen(c, WebChannel.EventType.MESSAGE, (t2) => {
        ...
        if (!h) {
          ...
          if (o2) {
            __PRIVATE_logDebug(
              fe,
              `RPC '${e}' stream ${r2} received error:`,
              o2,
            );
            const t3 = o2.status;
            let n3 =
            ...
            void 0 === n3 &&
              ...
              (h = true),
              P2.fo(new FirestoreError(n3, i3)),
              c.close();
          } else
            __PRIVATE_logDebug(fe, `RPC '${e}' stream ${r2} received:`, i2),
              P2.po(i2);
        }
      }),
      __PRIVATE_unguardedEventListen(o, Event.STAT_EVENT, (t2) => {
        t2.stat === Stat.PROXY
          ? __PRIVATE_logDebug(
              fe,
              `RPC '${e}' stream ${r2} detected buffering proxy`,
            )
          : t2.stat === Stat.NOPROXY &&
            __PRIVATE_logDebug(
              fe,
              `RPC '${e}' stream ${r2} detected no buffering proxy`,
            );
      }),
      setTimeout(() => {
        P2.mo();
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    (this.si = e),
      ...
      (this.Lo = i),
      (this.Bo = 0),
      (this.ko = null) /** The last backoff attempt, as epoch milliseconds. */,
      (this.qo = Date.now()),
      this.reset();
  }
  /**
  ...
  Ko(e) {
    ...
    r2 > 0 &&
      __PRIVATE_logDebug(
        "ExponentialBackoff",
        `Backing off for ${r2} ms (base delay: ${this.Bo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`,
      ),
      (this.ko = this.si.enqueueAfterDelay(
        this.timerId,
        r2,
        () => ((this.qo = Date.now()), e()),
...
var __PRIVATE_PersistentStream = class {
  ...
  t_() {
    this.Zo() &&
      null === this.jo &&
      (this.jo = this.si.enqueueAfterDelay(this.Wo, 6e4, () => this.n_()));
  }
  ...
  close(e, t) {
    return __async(this, null, function* () {
      this.i_(),
        this.s_(),
        this.Jo.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
        ...
        null !== this.stream &&
          (this.o_(), this.stream.close(), (this.stream = null)), // This state must be assigned before calling onClose() to allow the callback to
  ...
  h_(e) {
    ...
    (t.database = __PRIVATE_getEncodedDatabaseId(this.serializer)),
      (t.addTarget = (function __PRIVATE_toTarget(e2, t2) {
        ...
        const r2 = t2.target;
        if (
          ((n2 = __PRIVATE_targetIsDocumentTarget(r2)
            ? {
  ...
  Do(e, t, n, r2) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) =>
          this.connection.Do(e, __PRIVATE_toResourcePath(t, n), r2, i, s),
        )
        .catch((e2) => {
          throw "FirebaseError" === e2.name
            ? (e2.code === C2.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
                this.appCheckCredentials.invalidateToken()),
              e2)
            : new FirestoreError(C2.UNKNOWN, e2.toString());
        })
    );
  }
  ...
  Mo(e, t, n, r2, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) =>
          this.connection.Mo(e, __PRIVATE_toResourcePath(t, n), r2, s, o, i),
        )
        .catch((e2) => {
          throw "FirebaseError" === e2.name
            ? (e2.code === C2.UNAUTHENTICATED &&
    ...
    const i = __PRIVATE_debugCast(e),
      {
        ...
        const { _t: r3, parent: i2 } = __PRIVATE_toQueryTarget(e2, t2),
          s2 = {},
          o2 = [];
        let _2 = 0;
        return (
          n2.forEach((e3) => {
            ...
            (s2[t3] = e3.alias),
              "count" === e3.aggregateType
                ? o2.push({
                    alias: t3,
                    count: {},
                  })
                : "avg" === e3.aggregateType
                  ? o2.push({
                      alias: t3,
                      avg: {
        ...
        i.serializer,
        (function __PRIVATE_queryToAggregateTarget(e2) {
          const t2 = __PRIVATE_debugCast(e2);
          return (
            t2.he || // Do not include implicit order-bys for aggregate queries.
              (t2.he = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)),
            t2.he
          );
        })(t),
        n,
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.y_
      ? (__PRIVATE_logError(t), (this.y_ = false))
...
function __PRIVATE_remoteStoreListen(e, t) {
  ...
  n.F_.has(t.targetId) || // Mark this as something the client is currently listening for.
    (n.F_.set(t.targetId, t),
    __PRIVATE_shouldStartWatchStream(n)
      ? // The listen will be sent in onWatchStreamOpen
        __PRIVATE_startWatchStream(n)
      : __PRIVATE_ensureWatchStream(n).Zo() &&
        __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e),
    r2 = __PRIVATE_ensureWatchStream(n);
  n.F_.delete(t),
    r2.Zo() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.F_.size &&
      (r2.Zo()
        ? r2.t_()
...
function __PRIVATE_shouldStartWatchStream(e) {
  return (
    ...
    !__PRIVATE_ensureWatchStream(e).Yo() &&
    e.F_.size > 0
  );
}
  ...
  return __async(this, null, function* () {
    __PRIVATE_cleanUpWatchStreamState(e), // If we still need the watch stream, retry the connection.
      __PRIVATE_shouldStartWatchStream(e)
        ? (e.N_.D_(t), __PRIVATE_startWatchStream(e))
        ...
        (function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r2 of t2.targetIds)
              e2.F_.has(r2) &&
                (yield e2.remoteSyncer.rejectListen(r2, n2),
                e2.F_.delete(r2),
                e2.L_.removeTarget(r2));
          });
        })(e, t);
      } catch (n2) {
        __PRIVATE_logDebug(
...
function __PRIVATE_onMutationResult(e, t, n) {
  return __async(this, null, function* () {
    const r2 = e.v_.shift(),
      i = MutationBatchResult.from(r2, t, n);
...
function __PRIVATE_onWriteStreamClose(e, t) {
  return __async(this, null, function* () {
    t &&
      __PRIVATE_ensureWriteStream(e).T_ && // This error affects the actual write.
      (yield (function __PRIVATE_handleWriteError(e2, t2) {
        return __async(this, null, function* () {
          if (
            ...
            const n = e2.v_.shift();
            __PRIVATE_ensureWriteStream(e2).e_(),
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.M_.add(
      ...
      r2 && // Don't set the network status to Unknown if we are offline.
        n.N_.set(
          "Unknown",
          /* OnlineState.Unknown */
        ),
...
function __PRIVATE_ensureWatchStream(e) {
  return (
    e.B_ || // Create stream (but note that it is not started yet).
  ...
  return (
    e.k_ || // Create stream (but note that it is not started yet).
      ...
      e.x_.push((t) =>
        __async(this, null, function* () {
          t
            ? (e.k_.e_(), // This will start the write stream if necessary.
              yield __PRIVATE_fillWritePipeline(e))
            : (yield e.k_.stop(),
              e.v_.length > 0 &&
                (__PRIVATE_logDebug(
                  "RemoteStore",
                  `Stopping write stream with ${e.v_.length} pending writes`,
                ),
                (e.v_ = [])));
        }),
      )),
...
var DelayedOperation = class _DelayedOperation {
  ...
  static createAndSchedule(e, t, n, r2, i) {
    const s = Date.now() + n,
      o = new _DelayedOperation(e, t, s, r2, i);
    return o.start(n), o;
  }
  /**
...
function __PRIVATE_eventManagerListen(e, t) {
  return __async(this, null, function* () {
    ...
    s
      ? !s.W_() &&
        t.G_() && // Query has been listening to local cache, and tries to add a new listener sourced from watch.
        (r2 = 2)
      : ((s = new __PRIVATE_QueryListenersInfo()), (r2 = t.G_() ? 0 : 1));
    try {
      switch (r2) {
        case 0:
    ...
    if (
      (n.queries.set(i, s),
      s.U_.push(t), // Run global snapshot listeners if a consistent snapshot has been emitted.
      t.j_(n.onlineState),
      s.K_)
    ) {
    ...
    if (s) {
      ...
      e2 >= 0 &&
        ...
        0 === s.U_.length
          ? (i = t.G_() ? 0 : 1)
          : !s.W_() &&
            t.G_() && // The removed listener is the last one that sourced from watch.
            (i = 2));
    }
    switch (i) {
      case 0:
...
var __PRIVATE_QueryListener = class {
  ...
  H_(e) {
    ...
    return (
      this.Z_
        ? this.ea(e) && (this.Y_.next(e), (t = true))
        : this.ta(e, this.onlineState) && (this.na(e), (t = true)),
      (this.X_ = e),
      t
    );
  }
...
var __PRIVATE_BundleLoader = class {
  ...
  _a(e) {
    ...
    if (e.ia.namedQuery) this.queries.push(e.ia.namedQuery);
      ...
      e.ia.document &&
        ((this.documents[this.documents.length - 1].document = e.ia.document),
        ++t);
...
var __PRIVATE_View = class {
  constructor(e, t) {
    (this.query = e),
      ...
      (this.Ia = __PRIVATE_newQueryComparator(e)),
  ...
  da(e, t) {
    ...
    let i = t ? t.mutatedKeys : this.mutatedKeys,
      ...
      o = false;
    const _ =
        "F" === this.query.limitType && r2.size === this.query.limit
          ? r2.last()
          : null,
      a =
        "L" === this.query.limitType && r2.size === this.query.limit
          ? r2.first()
          : null;
    if (
      (e.inorderTraversal((e2, t2) => {
        const u = r2.get(e2),
          ...
          l2 = !!u && this.mutatedKeys.has(u.key),
          h =
            !!c &&
        ...
        if (u && c) {
          u.data.isEqual(c.data)
            ...
            : this.Ra(u, c) ||
              ...
              (P2 = true),
              ((_ && this.Ia(c, _) > 0) || (a && this.Ia(c, a) < 0)) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n, r2) {
    ...
    s.sort(
      (e2, t2) =>
        ...
        })(e2.type, t2.type) || this.Ia(e2.doc, t2.doc),
    ),
      this.Va(n),
      (r2 = null != r2 && r2);
    const o = t && !r2 ? this.ma() : [],
      _ = 0 === this.Pa.size && this.current && !r2 ? 1 : 0,
      a = _ !== this.ha;
  ...
  ga(e) {
    return (
      !this.la.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
      !!this.Ta.has(e) &&
  ...
  Va(e) {
    e &&
      (e.addedDocuments.forEach((e2) => (this.la = this.la.add(e2))),
      e.modifiedDocuments.forEach((e2) => {}),
      e.removedDocuments.forEach((e2) => (this.la = this.la.delete(e2))),
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    (this.localStore = e),
      (this.remoteStore = t),
      (this.eventManager = n),
      (this.sharedClientState = r2),
      (this.currentUser = i),
      (this.maxConcurrentLimboResolutions = s),
      (this.Sa = {}),
      (this.ba = new ObjectMap(
      ...
      (this.Na = __PRIVATE_TargetIdGenerator.Nn()),
    ...
    return (
      s
        ? // PORTING NOTE: With Multi-Tab Web, it is possible that a query view
          ...
          (r2.sharedClientState.addLocalQueryTarget(s.targetId),
          (i = s.view.ya()))
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  return __async(this, null, function* () {
    e.Ba = (t2, n2, r3) =>
      (function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
        return __async(this, null, function* () {
          ...
          const s2 = r4 && r4.targetChanges.get(t3.targetId),
            o2 = r4 && null != r4.targetMismatches.get(t3.targetId),
          ...
          return (
            __PRIVATE_updateTrackedLimbos(e2, t3.targetId, _2.fa), _2.snapshot
          );
        });
      })(e, t2, n2, r3);
...
function __PRIVATE_syncEngineUnlisten(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (r2.isPrimaryClient) {
      ...
      r2.sharedClientState.isActiveQueryTarget(i.targetId) ||
        (yield __PRIVATE_localStoreReleaseTarget(
          ...
          .then(() => {
            r2.sharedClientState.clearQueryState(i.targetId),
              n && __PRIVATE_remoteStoreUnlisten(r2.remoteStore, i.targetId),
              __PRIVATE_removeAndCleanupTarget(r2, i.targetId);
          })
...
function __PRIVATE_triggerRemoteStoreUnlisten(e, t) {
  return __async(this, null, function* () {
    ...
    n.isPrimaryClient &&
      ...
      __PRIVATE_remoteStoreUnlisten(n.remoteStore, r2.targetId));
  });
}
function __PRIVATE_syncEngineWrite(e, t, n) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      r2.sharedClientState.addPendingMutation(e2.batchId),
        ...
        yield __PRIVATE_fillWritePipeline(r2.remoteStore);
    } catch (e2) {
        ...
        r2 && // Since this is a limbo resolution lookup, it's for a single document
          ...
          e3.addedDocuments.size > 0
            ...
            : e3.modifiedDocuments.size > 0
              ? __PRIVATE_hardAssert(r2.wa)
              : e3.removedDocuments.size > 0 &&
                (__PRIVATE_hardAssert(r2.wa), (r2.wa = false)));
      }),
    ...
    r2.ba.forEach((n2, r3) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e3, t2) {
        ...
        n2.queries.forEach((e4, n3) => {
          for (const e5 of n3.U_) e5.j_(t2) && (r3 = true);
        }),
          r3 && __PRIVATE_raiseSnapshotsInSyncEvent(n2);
      })(r2.eventManager, t),
      e2.length && r2.Sa.l_(e2),
      (r2.onlineState = t),
      r2.isPrimaryClient && r2.sharedClientState.setOnlineState(t);
  }
}
  ...
  return __async(this, null, function* () {
    ...
    if (s) {
      ...
      yield __PRIVATE_syncEngineApplyRemoteEvent(r2, i2), // Since this query failed, we won't want to manually unlisten to it.
        ...
        (r2.va = r2.va.remove(s)),
        r2.Fa.delete(t),
        __PRIVATE_pumpEnqueuedLimboResolutions(r2);
    } else
      yield __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        t,
        ...
        .then(() => __PRIVATE_removeAndCleanupTarget(r2, t, n))
        .catch(__PRIVATE_ignoreIfPrimaryLeaseLoss);
  });
}
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      __PRIVATE_processUserCallback(
        ...
        __PRIVATE_triggerPendingWritesCallbacks(n, r2),
        n.sharedClientState.updateMutationState(r2, "acknowledged"),
        ...
        return n2.persistence.runTransaction(
          ...
          (e4) => {
            ...
            return n2.mutationQueue
              ...
              .next(() =>
                n2.documentOverlayCache.removeOverlaysForBatchId(e4, r3, t2),
              )
              .next(() =>
              ...
              .next(() => n2.localDocuments.getDocuments(e4, r3));
          },
        );
      })(r2.localStore, t);
      __PRIVATE_processUserCallback(r2, t, n),
        __PRIVATE_triggerPendingWritesCallbacks(r2, t),
        r2.sharedClientState.updateMutationState(t, "rejected", n),
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(r2, e2);
    } catch (n2) {
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      __PRIVATE_logDebug(
        "SyncEngine",
        "Document no longer in limbo: " + r2.key,
      ),
        e.Ma.removeReference(r2.key, t);
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Ca.size > 0 && e.va.size < e.maxConcurrentLimboResolutions; ) {
    ...
    const n = new DocumentKey(ResourcePath.fromString(t)),
      r2 = e.Na.next();
    e.Fa.set(r2, new LimboResolution(n)),
      (e.va = e.va.insert(n, r2)),
        ...
        o.push(
          r2.Ba(_, t, n).then((e3) => {
            if (
              ...
              ((e3 || n) &&
                r2.isPrimaryClient &&
                r2.sharedClientState.updateQueryState(
                  _.targetId,
                  (null == e3 ? void 0 : e3.fromCache)
                    ? "not-current"
                    : "current",
                ),
              e3)
        ...
        return __async(this, null, function* () {
          ...
          try {
            yield n2.persistence.runTransaction(
              ...
              (e3) =>
                PersistencePromise.forEach(t2, (t3) =>
                  PersistencePromise.forEach(t3.ki, (r3) =>
                    ...
                    PersistencePromise.forEach(t3.qi, (r3) =>
          ...
          for (const e3 of t2) {
            ...
            if (!e3.fromCache) {
              const e4 = n2.ts.get(t3),
                r3 = e4.snapshotVersion,
                i2 = e4.withLastLimboFreeSnapshotVersion(r3);
  ...
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      (n.currentUser = t), // Fails tasks waiting for pending writes requested by previous user.
        ...
        yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2._s);
    }
  });
}
...
function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  return __async(this, null, function* () {
    const n = __PRIVATE_debugCast(e),
      r2 = yield __PRIVATE_localStoreExecuteQuery(
        n.localStore,
        t.query,
        /* usePreviousResults= */
        true,
      ...
      i = t.view.pa(r2);
    return (
      n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.fa), i
    );
  });
}
  ...
  return __async(this, null, function* () {
    const i = __PRIVATE_debugCast(e),
      s = yield (function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
        const n2 = __PRIVATE_debugCast(e2),
          r3 = __PRIVATE_debugCast(n2.mutationQueue);
        return n2.persistence.runTransaction(
      ...
      n.Da.forEach((r2, i) => {
        ...
        (function __PRIVATE_resetLimboDocuments(e3) {
          ...
          t3.Fa.forEach((e4, n2) => {
            ...
            t3.Ma.Vr(),
            (t3.Fa = /* @__PURE__ */ new Map()),
            (t3.va = new SortedMap(DocumentKey.comparator));
        })(n),
        (n.La = false),
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r2.ba.get(e3),
            n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
          n3.snapshot && s.push(n3.snapshot);
        }
      } else {
        const n3 = yield __PRIVATE_localStoreGetCachedTarget(r2.localStore, e2);
        (t2 = yield __PRIVATE_localStoreAllocateTarget(r2.localStore, n3)),
      ...
      switch (n) {
        ...
        case "not-current": {
          const e2 = yield __PRIVATE_localStoreGetNewDocumentChanges(
            ...
            r3 = RemoteEvent.createSynthesizedRemoteEventForCurrentChange(
              t,
              "current" === n,
              ByteString.EMPTY_BYTE_STRING,
            );
  ...
  return __async(this, null, function* () {
    ...
    if (r2.La) {
      for (const e2 of t) {
        ...
        const t2 = yield __PRIVATE_localStoreGetCachedTarget(r2.localStore, e2),
          n2 = yield __PRIVATE_localStoreAllocateTarget(r2.localStore, t2);
        yield __PRIVATE_initializeViewAndComputeSnapshot(
          r2,
      ...
      for (const e2 of n)
        r2.Da.has(e2) && // Release queries that are still active.
          (yield __PRIVATE_localStoreReleaseTarget(
            ...
            .then(() => {
              __PRIVATE_remoteStoreUnlisten(r2.remoteStore, e2),
                __PRIVATE_removeAndCleanupTarget(r2, e2);
            })
            .catch(__PRIVATE_ignoreIfPrimaryLeaseLoss));
    }
  });
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.Sa.l_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.Sa.ka = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
        ...
        if (
          yield (function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
            const n3 = __PRIVATE_debugCast(e3),
              r4 = __PRIVATE_fromVersion(t3.createTime);
            return n3.persistence
              .runTransaction("hasNewerBundle", "readonly", (e4) =>
                n3.Kr.getBundleMetadata(e4, t3.id),
              )
              .then((e4) => !!e4 && e4.createTime.compareTo(r4) >= 0);
          })(e2.localStore, r3)
        )
          return (
            yield t2.close(),
        ...
        return (
          ...
          yield (function __PRIVATE_localStoreSaveBundle(e3, t3) {
            ...
            return n3.persistence.runTransaction(
              "Save bundle",
              "readwrite",
              (e4) => n3.Kr.saveBundleMetadata(e4, t3),
            );
          })(e2.localStore, r3),
          n2._completeWith(o.progress),
          Promise.resolve(o.ua)
        );
      } catch (e3) {
        return (
  ...
  createPersistence(e) {
    const t =
      void 0 !== this.cacheSizeBytes
        ...
        : LruParams.DEFAULT;
    return new __PRIVATE_MemoryPersistence(
      (e2) => __PRIVATE_MemoryLruDelegate.jr(e2, t),
      this.serializer,
    );
  }
};
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(
        ...
        yield this.Qa.initialize(this, e), // Enqueue writes from a previous session
        yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Qa.syncEngine),
        yield __PRIVATE_fillWritePipeline(this.Qa.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
        // set it after localStore / remoteStore are started.
        yield this.persistence.mi(
          () => (
            this.gcScheduler &&
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState &&
        ...
        // set it after localStore / remoteStore are started.
        yield this.persistence.mi((e2) =>
          __async(this, null, function* () {
            yield __PRIVATE_syncEngineApplyPrimaryState(this.Qa.syncEngine, e2),
              this.gcScheduler &&
      ...
      yield (function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
          ...
          __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."),
            ...
            yield __PRIVATE_disableNetworkInternal(t),
            t.O_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    (this.Ua = e),
      ...
      (this.Wa = (function __PRIVATE_newTextDecoder() {
        return new TextDecoder("utf-8");
      })()), // Read the metadata (which is the first element).
      this.Ga().then(
        (e2) => {
          e2 && e2.sa()
            ? this.metadata.resolve(e2.ia.metadata)
  ...
  za() {
    return __async(this, null, function* () {
      ...
      const e = this.Ja();
      e < 0 &&
        this.ja("Reached the end of bundle when a length string is expected.");
...
var __PRIVATE_TransactionRunner = class {
  ...
  nu(e) {
    this.Za > 0 && this.ru(e)
      ? ((this.Za -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.eu(), Promise.resolve())))
...
function __PRIVATE_canFallbackFromIndexedDbError(e) {
  return "FirebaseError" === e.name
    ? e.code === C2.FAILED_PRECONDITION || e.code === C2.UNIMPLEMENTED
    ...
    e.asyncQueue.enqueueAndForget(() =>
      __async(this, null, function* () {
        return (function __PRIVATE_readDocumentFromCache(e2, t2, n2) {
          return __async(this, null, function* () {
            try {
              const r2 = yield (function __PRIVATE_localStoreReadDocument(
                e3,
                t3,
              ) {
                const n3 = __PRIVATE_debugCast(e3);
              ...
              const r2 = __PRIVATE_wrapInUserErrorIfRecoverable(
                e3,
          ...
          const s = new __PRIVATE_AsyncObserver({
              next: (s2) => {
                ...
                !_ && s2.fromCache
                  ...
                  : _ && s2.fromCache && r3 && "server" === r3.source
                    ? i.reject(
                        new FirestoreError(
                          C2.UNAVAILABLE,
...
function collection(e, t, ...n) {
  if (
    ...
    return (
      __PRIVATE_validateCollectionPath(r2),
...
function doc(e, t, ...n) {
  if (
    ...
    const r2 = ResourcePath.fromString(t, ...n);
    return (
      __PRIVATE_validateDocumentPath(r2),
      new DocumentReference(
        e,
        /* converter= */
        null,
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  enqueueAfterDelay(e, t, n) {
    ...
    const r2 = DelayedOperation.createAndSchedule(this, e, t, n, (e2) =>
      this.Eu(e2),
    );
...
function getFirestore(t, n) {
  const r2 = "object" == typeof t ? t : getApp(),
    i = "string" == typeof t ? t : n || "(default)",
    s = _getProvider(r2, "firestore").getImmediate({
      identifier: i,
    });
  if (!s._initialized) {
...
function __PRIVATE_configureFirestore(e) {
  ...
  const i = e._freezeSettings(),
    s = (function __PRIVATE_makeDatabaseInfo(e2, t2, n2, r3) {
      return new DatabaseInfo(
        ...
        r3.host,
        r3.ssl,
        r3.experimentalForceLongPolling,
        r3.experimentalAutoDetectLongPolling,
        __PRIVATE_cloneLongPollingOptions(r3.experimentalLongPollingOptions),
        r3.useFetchStreams,
      );
    })(
      e._databaseId,
  ...
  (e._firestoreClient = new FirestoreClient(
    ...
    (null === (n = i.localCache) || void 0 === n
      ...
      (null === (r2 = i.localCache) || void 0 === r2
        ? void 0
        : r2._onlineComponentProvider) &&
...
function enableMultiTabIndexedDbPersistence(e) {
  ...
  const n = e._freezeSettings(),
    r2 = new OnlineComponentProvider();
  return __PRIVATE_setPersistenceProviders(
    t,
    r2,
    new __PRIVATE_MultiTabOfflineComponentProvider(r2, n.cacheSizeBytes),
  );
}
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  constructor(e, t, n, r2, i, s) {
    (this.settings = e),
      (this.databaseId = t),
      (this.serializer = n),
      (this.ignoreUndefinedProperties = r2), // Minor hack: If fieldTransforms is undefined, we assume this is an
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      n = this.Mu.map((e2) => __PRIVATE_parseData(e2, t)),
      r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return (
      e instanceof ___PRIVATE_ArrayUnionFieldValueImpl &&
      deepEqual(this.Mu, e.Mu)
    );
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      n = this.Mu.map((e2) => __PRIVATE_parseData(e2, t)),
      r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return (
...
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(
      e.serializer,
      toNumber(e.serializer, this.xu),
    );
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return (
      e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.xu === e.xu
    );
  }
};
function __PRIVATE_parseUpdateData(e, t, n, r2) {
  ...
  forEach(r2, (e2, r3) => {
    ...
    const a = i.Su(_2);
    if (r3 instanceof __PRIVATE_DeleteFieldValueImpl) s.push(_2);
    else {
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.Fu(1, t, n),
    _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)],
    a = [i];
  if (s.length % 2 != 0)
    throw new FirestoreError(
      C2.INVALID_ARGUMENT,
  ...
  return (function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      const n = t2.databaseId,
        r2 = e2.firestore._databaseId;
      if (!r2.isEqual(n))
        throw t2.Du(
          `Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`,
        );
      return {
...
function __PRIVATE_createError(e, t, n, r2, i) {
  ...
  return (
    (s || o) &&
      ...
      o && (a += ` in document ${i}`),
      (a += ")")),
    new FirestoreError(C2.INVALID_ARGUMENT, _ + e + a)
  );
}
...
function query(e, t, ...n) {
  let r2 = [];
  t instanceof AppliableConstraint && r2.push(t),
    (r2 = r2.concat(n)),
...
var QueryFieldFilterConstraint = class _QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _parse(e) {
    const t = __PRIVATE_newUserDataReader(e.firestore),
      n = (function __PRIVATE_newQueryFilter(e2, t2, n2, r2, i, s, o) {
        let _;
        if (i.isKeyField()) {
...
function orderBy(e, t = "asc") {
  const n = t,
    r2 = __PRIVATE_fieldPathFromArgument("orderBy", e);
  ...
  if (((n[0] = getModularInstance(n[0])), n[0] instanceof DocumentSnapshot$1))
    return (function __PRIVATE_newQueryBoundFromDocument(e2, t2, n2, r3, i) {
      ...
      for (const n3 of __PRIVATE_queryNormalizedOrderBy(e2))
        if (n3.field.isKeyField()) s.push(__PRIVATE_refValue(t2, r3.key));
        else {
    ...
    })(e._query, e.firestore._databaseId, t, n[0]._document, r2);
  {
    ...
    return (function __PRIVATE_newQueryBoundFromFields(e2, t2, n2, r3, i2, s) {
      ...
      if (i2.length > o.length)
        throw new FirestoreError(
          C2.INVALID_ARGUMENT,
          `Too many arguments provided to ${r3}(). The number of arguments must be less than or equal to the number of orderBy() clauses`,
        );
      const _ = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        ...
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof a)
            throw new FirestoreError(
              C2.INVALID_ARGUMENT,
              `Invalid query. Expected a string for document ID in ${r3}(), but got a ${typeof a}`,
            );
          if (!__PRIVATE_isCollectionGroupQuery(e2) && -1 !== a.indexOf("/"))
            throw new FirestoreError(
              C2.INVALID_ARGUMENT,
              `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r3}() must be a plain document ID, but '${a}' contains a slash.`,
            );
          const n3 = e2.path.child(ResourcePath.fromString(a));
          if (!DocumentKey.isDocumentKey(n3))
            throw new FirestoreError(
              C2.INVALID_ARGUMENT,
              `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${r3}() must result in a valid document path, but '${n3}' is not because it contains an odd number of segments.`,
            );
...
function __PRIVATE_parseDocumentIdValue(e, t, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    ...
    if (!DocumentKey.isDocumentKey(r2))
      throw new FirestoreError(
        C2.INVALID_ARGUMENT,
        `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r2}' is not because it has an odd number of segments (${r2.length}).`,
      );
...
var AbstractUserDataWriter = class {
  ...
  convertDocumentKey(e, t) {
    ...
    const r2 = new DatabaseId(n.get(1), n.get(3)),
      i = new DocumentKey(n.popFirst(5));
    return (
      r2.isEqual(t) || // TODO(b/64130202): Somehow support foreign references.
        __PRIVATE_logError(
          `Document ${i} contains a document reference within a different database (${r2.projectId}/${r2.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`,
        ),
      i
    );
  }
...
function aggregateFieldEqual(e, t) {
  ...
  return (
    ...
    (null === (n = e._internalFieldPath) || void 0 === n
      ? void 0
      : n.canonicalString()) ===
      (null === (r2 = t._internalFieldPath) || void 0 === r2
        ? void 0
        : r2.canonicalString())
  );
}
...
var QuerySnapshot = class {
  ...
  constructor(e, t, n, r2) {
    (this._firestore = e),
      (this._userDataWriter = t),
      (this._snapshot = r2),
      (this.metadata = new SnapshotMetadata(r2.hasPendingWrites, r2.fromCache)),
      (this.query = n);
  }
          ...
          (function __PRIVATE_changesFromSnapshot(e2, t2) {
            if (e2._snapshot.oldDocs.isEmpty()) {
              ...
              return e2._snapshot.docChanges.map((n) => {
                const r2 = new QueryDocumentSnapshot(
                  e2._firestore,
                  e2._userDataWriter,
                  n.doc.key,
                  n.doc,
...
function getDocFromCache(e) {
  ...
  const t = __PRIVATE_cast(e.firestore, Firestore),
    ...
    r2 = new __PRIVATE_ExpUserDataWriter(t);
...
function getDocs(e) {
  ...
  return (
    ...
    __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(n, e._query).then(
      (n2) => new QuerySnapshot(t, r2, e, n2),
    )
  );
}
...
function setDoc(e, t, n) {
  e = __PRIVATE_cast(e, DocumentReference);
  const r2 = __PRIVATE_cast(e.firestore, Firestore),
    i = __PRIVATE_applyFirestoreDataConverter(e.converter, t, n);
  return executeWrite(r2, [
    __PRIVATE_parseSetData(
      __PRIVATE_newUserDataReader(r2),
      "setDoc",
      e._key,
      i,
      null !== e.converter,
...
function updateDoc(e, t, n, ...r2) {
  ...
  o =
    "string" ==
      ...
      ? __PRIVATE_parseUpdateVarargs(s, "updateDoc", e._key, t, n, r2)
...
function addDoc(e, t) {
  ...
  return executeWrite(n, [
    __PRIVATE_parseSetData(
      ...
      null !== e.converter,
      {},
    ).toMutation(r2._key, Precondition.exists(false)),
  ]).then(() => r2);
}
function onSnapshot(e, ...t) {
  ...
  if (__PRIVATE_isPartialObserver(t[o])) {
    ...
    (t[o] = null === (n = e2.next) || void 0 === n ? void 0 : n.bind(e2)),
      (t[o + 1] =
        null === (r2 = e2.error) || void 0 === r2 ? void 0 : r2.bind(e2)),
      (t[o + 2] =
  ...
  return (function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    const i2 = new __PRIVATE_AsyncObserver(r3),
...
function getAggregateFromServer(e, t) {
  const n = __PRIVATE_cast(e.firestore, Firestore),
    r2 = ensureFirestoreConfigured(n),
    i = (function __PRIVATE_mapToArray(e2, t2) {
      const n2 = [];
      for (const r3 in e2)
        Object.prototype.hasOwnProperty.call(e2, r3) &&
          n2.push(t2(e2[r3], r3, e2));
      return n2;
    })(
      t,
      (e2, t2) =>
...
var WriteBatch = class {
  ...
  set(e, t, n) {
    ...
    const r2 = __PRIVATE_validateReference(e, this._firestore),
      i = __PRIVATE_applyFirestoreDataConverter(r2.converter, t, n),
    ...
    return (
      this._mutations.push(s.toMutation(r2._key, Precondition.none())), this
    );
  }
  update(e, t, n, ...r2) {
    this._verifyNotCommitted();
...
function setIndexConfiguration(e, t) {
  ...
  if (
    !r2._uninitializedComponentsProvider ||
    "memory" ===
      (null === (n = r2._uninitializedComponentsProvider) || void 0 === n
        ? void 0
        : n._offlineKind)
  )
    return (
  ...
  const i = (function __PRIVATE_parseIndexes(e2) {
    ...
    if (Array.isArray(t2.indexes))
      for (const e3 of t2.indexes) {
        ...
        n2.push(
          new FieldIndex(FieldIndex.UNKNOWN_ID, t3, r3, IndexState.empty()),
        );
      }
    return n2;
  })(t);
...
function getPersistentCacheIndexManager(e) {
  ...
  if (
    "persistent" !==
    (null === (t = r2._uninitializedComponentsProvider) || void 0 === t
      ? void 0
      : t._offlineKind)
  )
    return null;
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  static get instance() {
    return (
      ve ||
        ((ve = new ___PRIVATE_TestingHooksSpiImpl()),
...
!(function __PRIVATE_registerFirestore(e, t = true) {
  !(function __PRIVATE_setSDKVersion(e2) {
    ...
    _registerComponent(
      new Component(
        "firestore",
        (e2, { instanceIdentifier: n, options: r2 }) => {
    ...
    registerVersion(S2, "4.6.1", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
